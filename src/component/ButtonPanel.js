...
export default class ButtonPanel extends React.Component {
  ...
  // Some buttons have an additional  property to signify a styling choice.
  // The button with the name "0" has a wide property for styling as well.
  render() {
    return (
      <div className="component-button-panel">
        <div>
          <Button name="÷" clickHandler={this.buttonClicked} grey />
          <Button name="AC" clickHandler={this.buttonClicked} orange />
          <Button name="+/-" clickHandler={this.buttonClicked} orange />
          <Button name="%" clickHandler={this.buttonClicked} orange />
        </div>
        <div>
          <Button name="x" clickHandler={this.buttonClicked} grey />
